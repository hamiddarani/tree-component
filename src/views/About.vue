  ...
  <div id="app" class="container mt-4">
    <div class="d-flex justify-content-start">
      <b-button
        ...
        @click="reset"
        >Add new post</b-button
      >
    </div>

    <b-alert :show="error" variant="danger" class="my-2"
      >all fields must be required</b-alert
    >
        ...
        <b-tr v-for="post in posts" :key="post.id">
          ...
          <b-td class="d-flex">
            <b-button
              ...
              >delete</b-button
            >
            <b-button variant="primary" size="sm" @click="editHandlaer(post)"
              >edit</b-button
            >
          </b-td>
        </b-tr>
    ...
    <b-modal ref="my-modal" id="my-modal" @ok="submit">
      <template #modal-title> add new post </template>
